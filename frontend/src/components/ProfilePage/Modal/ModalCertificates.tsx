...
const ModalCertificates: React.FC<ModalProps> = ({ closeModal }) => {
  const { t } = useLocale();
  return (
        ...
        <div className='h-[420px] overflow-y-auto'>
          <div className='px-6 py-3'>
            <div className=' flex flex-col gap-3'>
              ...
              <div>
                <p>
                  {t('Certificates Name')} <span className='text-red'>*</span>
                </p>
                <input
                  type='text'
                  id='default-input'
              ...
              <div>
                <p>
                  {t('Organization')} <span className='text-red'>*</span>
                </p>
                <input
                  type='text'
                  id='default-input'
